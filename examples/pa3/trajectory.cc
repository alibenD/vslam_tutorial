...
using Poses = std::vector<Sophus::SE3, Eigen::aligned_allocator<Sophus::SE3>>;
void DrawTrajectory(Poses poses1, Poses poses2);
void DrawTrajectory(Poses pose1);
...
int main(int argc, char **argv) {
  ...
  if(argc == 2)
  {
    ...
    DrawTrajectory(poses_gt, poses_estimate);
    return 0;
}
