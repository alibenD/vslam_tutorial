/**
  ...
  * @last_modified_date: 2019-01-14 21:41:16
  * @brief: TODO
  * @details: TODO
  */
...
class ConfigYAMLTest : public testing::Test
{
  protected:
    virtual void SetUp() override
    {
      ...
      outfile << "%YAML:1.0" << std::endl;
      outfile << "testInt: 100" << std::endl;
      outfile.close();
    }
...
TEST_F(ConfigYAMLTest, read)
{
  config_yaml_->open("empty.yaml");
  EXPECT_EQ(config_yaml_->getItem<int>("testInt"), 100);
}
